      ...
      child: ListView(
        ...
        children: <Widget>[
          new UserAccountsDrawerHeader(
            accountName: new Text(_getuser().toString()),
            accountEmail: new Text(_getuser().toString()),
...
class feedPage extends State<Feed>{
  ...
  Future _makeApiCall() async {
    ...
    Dio dio = new Dio();
    Response apiResponse = await dio.get('http://192.168.0.188:3030/get_feed'); //Where id is just a parameter in GET api call
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(username + " rated this book with "+rate+" stars", style: TextStyle(color: Colors.grey),),
                ...
                Column(
                  ...
                  children: <Widget>[
                    SizedBox(
                        ...
                        child: Text(name, style: TextStyle(fontSize: 17),)),
                    SizedBox(height: 10,),
                    Text(director, style: TextStyle(color: Colors.grey),),
                    Text(username + " rated this movie with " + rate +" stars", style: TextStyle(color: Colors.grey),),
                    Text(date, style: TextStyle(color: Colors.grey),),
                  ],
                )
              ],
