...
Response apiResponse;
  ...
  Future<void> _makeApiCall() async {
    //var a=200;
    Dio dio = new Dio();
    apiResponse = await dio.post('http://192.168.0.188:3030/login', data:{"username":nameController.text,"password":passwordController.text}); //Where id is just a parameter in GET api call
